    ...
    <>
      <div className="bg-white dark:bg-slate-900 text-slate-900 dark:text-gray-100">
        ...
        <section className="relative min-h-[calc(100vh-7rem)] w-full flex items-center overflow-hidden">
          ...
          {/* 🔹 Dekoracyjna fala lub maska — opcjonalna */}
          <svg
          ...
          >
            <defs>
              ...
              {/* 🌙 Gradient dla trybu ciemnego — z dołu do góry */}
              <linearGradient id="headerWaveDark" x1="0" y1="1" x2="0" y2="0">
                <stop offset="0%" stopColor="#10172A" /> {/* dół */}
                <stop offset="100%" stopColor="#10172A" /> {/* góra */}
              </linearGradient>
            </defs>
            <path
            ...
            >
              ...
              >
                <Img
                  ...
                  className="rounded-[2.5rem] shadow-2xl border border-white/20"
                />
