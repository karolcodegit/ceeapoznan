    ...
    <div className="md:w-1/4 xl:w-1/4 xl:sticky xl:top-0 xl:right-0 xl:max-h-[calc(100vh-15vh)] overflow-y-auto mx-auto">
      <div className="rounded-md flex flex-col h-full">
        <div className="p-5 flex flex-col items-center justify-center">
          <CurrencyDollarIcon
            className="h-8 w-8 mb-2 dark:text-gray-200"
            aria-hidden="true"
          />
          <span className="font-normal text-sm dark:text-gray-200">
            Cena kursu:{" "}
          </span>
          <span className="font-bold py-2 text-3xl dark:text-gray-50">
        ...
        <div className="p-5 flex flex-col items-center justify-center">
          <span
            className={`font-bold text-center text-2xl mb-5 px-4 py-2 rounded-lg shadow-md transition-all duration-300 transform ${
              available
                ? "bg-green-500 text-white dark:bg-green-700 dark:text-white"
                : "bg-red-500 text-white dark:bg-red-700 dark:text-white"
            } ${available ? "animate-pulse" : ""} text-shadow-lg`}
          >
